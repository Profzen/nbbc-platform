...
export const config = {
  ...
  matcher: ["/((?!login|register|kyc\\/[0-9a-f-]{36}|sign\\/[0-9a-f-]{36}|api\\/kyc\\/(?!requests)[^/]+|api\\/signatures\\/(?!templates|requests)[^/]+|api\\/cloudinary\\/sign|api\\/auth|api\\/setup-admin|_next\\/static|_next\\/image|favicon\\.ico).*)"],
};
